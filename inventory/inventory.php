...
// Base SQL query
$sql = "SELECT 'Equipment' as item_type, item_name, item_code, item_qty, item_unit, item_brand, date_purchase, item_location, item_life, item_remarks FROM `item_equipment`";
$sql .= " UNION ALL ";
