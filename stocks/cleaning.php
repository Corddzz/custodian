                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<a href='../stockin/cleaning_stocks.php?item_name=" . urlencode($row["item_name"]) . "' class='btn btn-info btn-sm'> <span >View</span> <i class='fa-solid fa-arrow-up-right-from-square'></i>  </a>";
                                    echo "</td>";
                                    echo "</tr>";
                                }
                            } else {
