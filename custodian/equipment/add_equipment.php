    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 overflow-x-hidden overflow-y-auto">
            <div class="container mx-auto p-6">
                <h1 class="text-3xl font-bold mb-6 text-gray-800">Add New Equipment</h1>
                
                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    <form action="" method="POST">
                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-bold mb-2" for="equipment_item">
                                Equipment/Item
                            </label>
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="equipment_item" name="equipment_item" type="text" placeholder="Enter equipment/item name" required>
                        </div>
                        <div class="mb-4">
