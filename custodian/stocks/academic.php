                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<a href='../stockin/cleaning_stocks.php?item_name=" . urlencode($row["item_name"]) . "' class='btn btn-info btn-sm'>+/-</a>";

                                    // echo '<button type="button" class="btn btn-success"><i class="fa-solid fa-plus"></i></button>';
