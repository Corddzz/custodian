...
// Base SQL query
$sql = "SELECT 'academic_item' as item_type, item_name, item_code, item_qty, item_unit, item_brand, date_purchase, item_location, item_life, item_remarks FROM `item_equipment`";
$sql .= " UNION ALL ";
$sql .= "SELECT 'Academic' as item_type, item_name, item_code, item_qty, item_unit, item_brand, date_purchase, item_location, item_life, item_remarks FROM `academic_item`";
$sql .= " UNION ALL ";
$sql .= "SELECT 'Cleaning' as item_type, item_name, item_code, item_qty, item_unit, item_brand, date_purchase, item_location, item_life, item_remarks FROM `cleaning_item`";
$sql .= " UNION ALL ";
$sql .= "SELECT 'Medical' as item_type, item_name, item_code, item_qty, item_unit, item_brand, date_purchase, item_location, item_life, item_remarks FROM `medical_item`";
