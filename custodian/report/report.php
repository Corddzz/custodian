...
<body>
    <div class="container mt-4">
        <div>
            <button type="button" class="btn btn-primary" onclick="window.location.href='/custodian/index.php'">Back</button>
        </div>
        <h1 class="text-center mb-4">Comprehensive Inventory Report</h1>
